lv_obj_t* createScreen() {
  ...
  lv_obj_set_style_pad_left(screen, UI_OFFSET_X, 0);
  lv_obj_set_style_pad_right(screen, UI_OFFSET_X, 0);
  lv_obj_set_style_pad_top(screen, UI_OFFSET_Y, 0);
  lv_obj_set_style_pad_bottom(screen, UI_OFFSET_Y, 0);
