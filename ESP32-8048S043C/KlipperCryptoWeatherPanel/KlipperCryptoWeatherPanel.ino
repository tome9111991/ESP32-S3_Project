...
static constexpr int LCD_BOUNCE_LINES = 20;
...
static lv_obj_t* klipperMmuGateEmptyLine[MMU_GATE_MAX] = {};
static lv_point_precise_t klipperMmuGateEmptyPts[MMU_GATE_MAX][2] = {};
